/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e422c0631ef332f891ba85abc167bc22)
// Runtime types generated with workerd@1.20260609.1 2026-06-01 
interface __BaseEnv_Env {
	...
	ADMIN_EMAILS: string;
	BATTLE_ROOM: DurableObjectNamespace<import("./worker/index").BattleRoomDO>;
	LOBBY: DurableObjectNamespace<import("./worker/index").LobbyDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "BattleRoomDO" | "LobbyDO";
	}
